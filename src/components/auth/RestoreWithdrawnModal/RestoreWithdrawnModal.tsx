...
import { RestoreModal, Modal, Input, Button } from '@/components'
import { MehFaceIcon } from './icons'
import { useRestoreWithdrawnModal } from '@/hooks/useRestoreWithdrawnModal'
...
export function RestoreWithdrawnModal({
  ...
  const {
    ...
    onConfirmRestore,
    onNavigateToLogin,
  } = useRestoreWithdrawnModal({ isOpen, onClose, initialEmail })
